...
ANS: JSX বা JavaScript XML হলো JavaScript-এর এমন একটি পদ্ধতি যা JavaScript ফাইলের ভেতরেই HTML-এর মতো কোড লিখতে সাহায্য করে।

Why is it used?

ANS: JSX ছাড়া React-এ কোড লেখা বেশ কঠিন এবং সময়সাপেক্ষ।
